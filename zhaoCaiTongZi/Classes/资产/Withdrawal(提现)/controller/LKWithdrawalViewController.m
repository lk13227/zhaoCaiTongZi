...
@interface LKWithdrawalViewController ()
...
@implementation LKWithdrawalViewController
...
- (void)setUpUI
{
    ...
    [self.promptLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.withdrawalBtn.mas_bottom).offset(30);
