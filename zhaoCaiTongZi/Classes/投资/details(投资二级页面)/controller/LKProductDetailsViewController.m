...
- (void)setUpData
{
    ...
    //发送请求
    [[AFHTTPSessionManager manager] POST:[NSString stringWithFormat:@"%@financingproddetails.do",testURL] parameters:params progress:^(NSProgress * _Nonnull uploadProgress) {
